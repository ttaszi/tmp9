const contractAddress = "0xB5Ea8ba7cBc9d4606063041B1988B84F3f296981"; // Replace with your own contract address
const chain = 'polygon'; // goerli, polygon, or ethereum

const welcome_h1 = "Welcome to the GYU NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The GYU NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection.';
